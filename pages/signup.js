...
export default function signup() {
  ...
  return (
    ...
    <div className=' border-white backdrop-blur-md rounded-lg w-96 h-96 border-4 flex flex-col justify-center align-center items-center space-y-32 '>
       <div className='text-zinc-950 flex flex-col justify-center items-center space-y-3 '>
        ...
        <div className='flex flex-row'>
            ...
            <input placeholder="username" label="username" type="email" ref={emailRef} />
        </div><br/>
        <div className='flex flex-row'>
            <h3 className='text-white w-24'>password</h3>
            <input placeholder="password" label="password" type="password" value={msg} onChange={(e) => setMsg(e.target.value)}/>
        </div><br/>
        <button className='text-white bg-transparent border-white border-2 rounded-lg w-36 h-10' inClick={test}>submit</button>
       </div>
